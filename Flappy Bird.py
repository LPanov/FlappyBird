...
game = Game('C:/IOT and CC++ courses/Python Codio/bird.png', 'C:/IOT and CC++ courses/Python Codio/pipe.png', 'C:/IOT and CC++ courses/Python Codio/background.png', 'C:/IOT and CC++ courses/Python Codio/ground.png')
game.resize_images()
